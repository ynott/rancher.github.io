...
$ sudo docker run -d --restart=unless-stopped -p 8080:8080 \
    ...
    rancher/server
```<a id="http-proxy"></a>### Launching Rancher Server behind an HTTP proxy
