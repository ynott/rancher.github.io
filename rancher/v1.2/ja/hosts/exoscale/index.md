...
title: Adding Exoscale Hosts layout: rancher-default-v1.2 version: v1.2 lang: en redirect_from: - /rancher/v1.2/en/rancher-ui/infrastructure/hosts/exoscale/ - /rancher/latest/en/hosts/exoscale/
...
In the **Custom** option, you can choose an existing security group, but you will need to ensure that specific ports are open in order for Rancher to be working correctly.<a id="Ports"></a>### Required Ports for Rancher to work:
...
Once you click on create, Rancher will create the Exoscale instance and launch the *rancher-agent* container in the instance. In a couple of minutes, the host will be active and available for [services]({{site.baseurl}}/rancher/{{page.version}}/{{page.lang}}/cattle/adding-services/).